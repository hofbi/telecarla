      ...
      )
{
    ...
    server_.bind("set_enable_autopilot",
                 com::RPCMsgCallback<data::Bool>(nh.advertise<std_msgs::Bool>(prefix + "/enable_autopilot", 1)));
    ROS_INFO_STREAM("Provide RPC call set_enable_autopilot -> " << prefix << "/enable_autopilot");
    server_.bind(
        "set_vehicle_control_manual_override",
        com::RPCMsgCallback<data::Bool>(nh.advertise<std_msgs::Bool>(prefix + "/vehicle_control_manual_override", 1)));
    ...
    server_.bind("set_vehicle_control_cmd_manual",
                 com::RPCMsgCallback<data::ControlCommands>(
